...
export function RoleAssignmentPanel() {
  ...
  return (
    <Block title="Role Assignment" icon={KeyRound} action="Assign role">
          ...
          return (
            ...
            >
              <div className="min-w-0">
                <div className={`truncate text-[13.5px] font-bold ${FG}`}>{p.name}</div>
                <div className={`truncate text-[12.5px] ${MUTED}`}>{p.dept}</div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="min-h-9 rounded-lg border border-[oklch(0.27_0.025_285)] bg-[oklch(0.205_0.028_285)] px-2 text-[12.5px] font-semibold text-[oklch(0.86_0.02_285)] outline-none focus-visible:border-[oklch(0.72_0.168_265)] focus-visible:ring-4 focus-visible:ring-[oklch(0.72_0.168_265)]/15"
                >
              ...
              {selecting && (
                <div className="col-span-2 flex flex-wrap items-center gap-2 border-t border-[oklch(0.27_0.025_285)] pt-2">
                  <span className="text-[12.5px] text-[oklch(0.78_0.147_75)]">
                  ...
                  <div className="ml-auto flex gap-1.5">
                    <Button
                      ...
                      className="h-8 min-h-9 gap-1 rounded-lg border border-[oklch(0.27_0.025_285)] px-2.5 text-[12.5px] text-[oklch(0.86_0.02_285)]"
                    >
                    ...
                    <Button
                      ...
                      className="h-8 min-h-9 gap-1 rounded-lg border border-[oklch(0.38_0.08_265)] bg-[oklch(0.72_0.168_265)]/14 px-2.5 text-[12.5px] text-[oklch(0.78_0.14_265)]"
                    >
      ...
      <p aria-live="polite" className={`text-[12.5px] ${status ? "text-[oklch(0.72_0.1725_155)]" : MUTED}`}>
