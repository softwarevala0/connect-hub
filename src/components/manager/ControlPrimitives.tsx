  ...
  return (
    <section className="rounded-2xl border border-[oklch(0.27_0.025_285)] bg-[oklch(0.205_0.028_285)] p-5 shadow-[0_1px_2px_rgba(0,0,0,0.09)] md:p-6">
      <header className="mb-4 flex flex-wrap items-center gap-2">
        ...
        <span className="rounded-full border border-[oklch(0.27_0.025_285)] bg-[oklch(0.185_0.02_285)] px-2 py-0.5 text-[13px] font-semibold text-[oklch(0.72_0.02_285)]">
          Control-plane changes
        </span>
        <Button
          type="button" variant="ghost" size="sm"
          onClick={() => requestSection("audit")}
          className="ml-auto min-h-9 rounded-lg px-2 text-[14px] font-semibold text-[oklch(0.72_0.168_265)] hover:bg-[oklch(0.185_0.02_285)] hover:text-[oklch(0.68_0.184_268)]"
        >
        ...
        {TIMELINE.map((t) => (
          <li key={t.title} className="group relative">
            ...
            <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5 rounded-lg px-2 py-1 transition-colors hover:bg-[oklch(0.185_0.02_285)]">
              <span className="text-[15.5px] font-semibold text-[oklch(0.965_0.012_285)]">{t.title}</span>
              <span className="text-[14px] text-[oklch(0.72_0.02_285)]">{t.meta}</span>
              <span className="ml-auto inline-flex items-center gap-1 font-mono text-[13.5px] text-[oklch(0.72_0.02_285)]">
      ...
      {MODULES.map((m) => (
        ...
        >
          <div className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-start gap-3">
            ...
            <div className="min-w-0">
              <div className="flex min-w-0 items-center gap-2">
                <h4 className="truncate text-[16px] font-bold text-[oklch(0.965_0.012_285)]">{m.name}</h4>
                <span className="shrink-0 rounded-md bg-[oklch(0.185_0.02_285)] px-1.5 py-0.5 font-mono text-[12.5px] font-bold text-[oklch(0.72_0.02_285)]">{m.code}</span>
              </div>
              <p className="mt-0.5 line-clamp-2 text-[14.5px] leading-relaxed text-[oklch(0.72_0.02_285)]">{m.desc}</p>
            </div>
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <span className="shrink-0 font-mono text-[13.5px] font-bold text-[oklch(0.68_0.1725_155)]">{m.health}% health</span>
            <Button
              type="button" variant="ghost" size="sm"
              aria-label={`Configure ${m.name} module`}
              onClick={() => run(moduleConfigSpec(m))}
              className="min-h-9 shrink-0 gap-1 rounded-lg border border-[oklch(0.27_0.025_285)] px-2 text-[13.5px] font-semibold text-[oklch(0.86_0.02_285)] opacity-100 transition-all hover:bg-[oklch(0.185_0.02_285)] focus-visible:opacity-100 md:opacity-0 md:group-hover:opacity-100"
            >
